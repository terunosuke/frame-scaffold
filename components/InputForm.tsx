                        ...
                        <div className="space-y-3 p-4 bg-green-50 rounded-lg border border-green-100">
                            ...
                            {config.perimeterSheetMode === 'required' && (
                                <div className="ml-4 space-y-2">
                                    <InputGroup label="必要段数（3段/1枚、端数切上げ。例：4段→2枚）" as="select" value={config.perimeterSheetLevelMode} onChange={e => setConfigField('perimeterSheetLevelMode', e.target.value as 'all' | 'custom')}>
                                        <option value="all">全段</option>
